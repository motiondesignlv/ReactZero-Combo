  ...
  build: {
    lib: {
      entry: {
        ...
        hook: resolve(__dirname, 'src/entries/hook.ts'),
        'hook-bare': resolve(__dirname, 'src/entries/hook-bare.ts'),
        slots: resolve(__dirname, 'src/entries/slots.ts'),
        tabs: resolve(__dirname, 'src/entries/tabs.ts'),
        icons: resolve(__dirname, 'src/entries/icons.ts'),
        position: resolve(__dirname, 'src/entries/position.ts'),
      },
      formats: ['es', 'cjs'],
